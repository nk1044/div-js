...
const Sidebar01 = ({ tree, previewMode=true }) => {
  ...
  // In preview mode, we force desktop view so that the sidebar is always visible
  const mobileView = previewMode ? false : isMobile;

  // Use 'absolute' positioning in preview mode so that the sidebar fits inside the wrapper.
  const asideClass = previewMode
    ? "absolute left-0 top-0 h-full bg-gray-900 text-gray-100 p-6 w-1/5 min-w-[200px] max-w-[300px] overflow-y-auto"
    : "fixed left-0 top-0 h-screen bg-gray-900 text-gray-100 p-6 w-1/5 min-w-[200px] max-w-[300px] overflow-y-auto";
    ...
    <div className="min-h-screen overflow-x-hidden bg-gray-100 text-gray-800">
      ...
      <div className="flex flex-col md:flex-row">
        {mobileView ? (
          ...
          // Desktop Sidebar (or preview mode sidebar)
